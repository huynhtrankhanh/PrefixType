  ...
  try {
    ...
    await run('daily export clips midnight/DST and recovery closes interrupted sessions', async () => {
      ...
      const result = await tab.evaluate(async () => {
        ...
        tx.objectStore('sessions').put({ id: 'dst-session', a: dayStart - 1000, c: dayEnd + 1000, z: dayEnd + 1000, r: 'completed', x: 'abc', q: 'America/New_York', o: 300 });
        ...
        return { record: await PrefixType.buildDailyRecord('2026-03-08'), dayStart, dayEnd };
      });
